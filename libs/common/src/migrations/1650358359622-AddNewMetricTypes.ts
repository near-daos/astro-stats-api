...
export class AddNewMetricTypes1650358359622 implements MigrationInterface {
  name = 'AddNewMetricTypes1650358359622';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."dao_stats_history_metric_enum" AS ENUM('DAO_COUNT', 'ACCOUNT_BALANCE', 'ACTIONS_IN_COUNT', 'ACTIONS_OUT_COUNT', 'ACTIONS_FUNCTION_CALL_IN_COUNT', 'ACTIONS_FUNCTION_CALL_OUT_COUNT', 'ACTIONS_DEPOSIT_IN_COUNT', 'ACTIONS_DEPOSIT_IN_VALUE', 'ACTIONS_DEPOSIT_OUT_COUNT', 'ACTIONS_DEPOSIT_OUT_VALUE', 'GROUPS_COUNT', 'COUNCIL_SIZE', 'MEMBERS_COUNT', 'PROPOSALS_COUNT', 'PROPOSALS_TRANSFER_COUNT', 'PROPOSALS_VOTE_COUNT', 'PROPOSALS_ACTIVE_VOTE_COUNT', 'PROPOSALS_COUNCIL_MEMBER_COUNT', 'PROPOSALS_POLICY_CHANGE_COUNT', 'PROPOSALS_IN_PROGRESS_COUNT', 'PROPOSALS_APPROVED_COUNT', 'PROPOSALS_REJECTED_COUNT', 'PROPOSALS_EXPIRED_COUNT', 'PROPOSALS_BOUNTY_COUNT', 'PROPOSALS_MEMBER_COUNT', 'BOUNTIES_COUNT', 'BOUNTIES_VALUE_LOCKED', 'FTS_COUNT', 'FTS_VALUE_LOCKED', 'NFTS_COUNT', 'NFTS_VALUE_LOCKED')`,
    );
    await queryRunner.query(
